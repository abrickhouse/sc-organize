...
insert into MEMBER (member_ID, name, email, role, total_hours, tasks_in_progress, lead_ID, team_ID) values (3, 'Irvin', 'igodber2@squidoo.com', 'Developer', 10, 2, 4, 7);
...
insert into MEMBER (member_ID, name, email, role, total_hours, tasks_in_progress, lead_ID, team_ID) values (5, 'Callean', 'cblaskett4@alibaba.com', 'Developer', 11, 0, 3, 10);
...
insert into MEMBER (member_ID, name, email, role, total_hours, tasks_in_progress, lead_ID, team_ID) values (13, 'Gare', 'gphilippc@theglobeandmail.com', 'Designer', 12, 1, 4, 7);
...
insert into MEMBER (member_ID, name, email, role, total_hours, tasks_in_progress, lead_ID, team_ID) values (15, 'Clarance', 'chustere@dion.ne.jp', 'Designer', 6, 3, 4, 7);
...
insert into MEMBER (member_ID, name, email, role, total_hours, tasks_in_progress, lead_ID, team_ID) values (18, 'Bronson', 'btoulminh@reuters.com', 'Designer', 2, 0, 10, 7);
...
insert into MEMBER (member_ID, name, email, role, total_hours, tasks_in_progress, lead_ID, team_ID) values (26, 'Tommie', 'twarrackp@deviantart.com', 'Designer', 20, 1, 10, 9);
...
insert into MEMBER (member_ID, name, email, role, total_hours, tasks_in_progress, lead_ID, team_ID) values (30, 'Phillida', 'pmcmastert@vk.com', 'Developer', 8, 1, 4, 7);
...
insert into MEMBER (member_ID, name, email, role, total_hours, tasks_in_progress, lead_ID, team_ID) values (38, 'Jordon', 'jmanuel11@globo.com', 'Designer', 1, 6, 4, 7);
...
insert into TASK (name, proj_title, client_ID, type, member_ID, lead_ID, task_number, date_assigned, date_due, date_finished, completion_status, hours, description) values ('Multi-tiered background parallelism', 'Treeflex', 4, 'Design', 25, 12, 35, '2022-9-20', '2022-10-16', null, false, null, 'Maecenas leo odio, condimentum id, luctus nec, molestie sed, justo. Pellentesque viverra pede ac diam. Cras pellentesque volutpat dui.');
...
insert into TASK (name, proj_title, client_ID, type, member_ID, lead_ID, task_number, date_assigned, date_due, date_finished, completion_status, hours, description) values ('Integrated holistic capability', 'Stereo', 7, 'Design', 38, 4, 52, '2022-9-25', '2022-10-3', null, false, null, 'Cras non velit nec nisi vulputate nonummy. Maecenas tincidunt lacus at velit. Vivamus vel nulla eget eros elementum pellentesque.

Quisque porta volutpat erat. Quisque erat eros, viverra eget, congue eget, semper rutrum, nulla. Nunc purus.');
insert into TASK (name, proj_title, client_ID, type, member_ID, lead_ID, task_number, date_assigned, date_due, date_finished, completion_status, hours, description) values ('Self-enabling demand-driven core', 'Stereo', 7, 'Design', 23, 4, 53, '2022-10-8', '2022-10-28', '2022-10-23', true, 1, 'Pellentesque at nulla. Suspendisse potenti. Cras in purus eu magna vulputate luctus.');
insert into TASK (name, proj_title, client_ID, type, member_ID, lead_ID, task_number, date_assigned, date_due, date_finished, completion_status, hours, description) values ('Total object-oriented solution', 'Stereo', 7, 'Design', null, 4, 54, null, null, null, false, null, 'Pellentesque at nulla. Suspendisse potenti. Cras in purus eu magna vulputate luctus.

Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.');
insert into TASK (name, proj_title, client_ID, type, member_ID, lead_ID, task_number, date_assigned, date_due, date_finished, completion_status, hours, description) values ('Implemented analyzing database', 'Stereo', 7, 'Design', null, 4, 55, null, null, null, false, null, 'Proin interdum mauris non ligula pellentesque ultrices. Phasellus id sapien in sapien iaculis congue. Vivamus metus arcu, adipiscing molestie, hendrerit at, vulputate vitae, nisl.');
insert into TASK (name, proj_title, client_ID, type, member_ID, lead_ID, task_number, date_assigned, date_due, date_finished, completion_status, hours, description) values ('Profound motivating functionalities', 'Stereo', 7, 'Design', 22, 4, 56, '2022-11-15', '2022-11-28', '2022-11-23', true, 5, 'Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat.');
insert into TASK (name, proj_title, client_ID, type, member_ID, lead_ID, task_number, date_assigned, date_due, date_finished, completion_status, hours, description) values ('Managed object-oriented process improvement', 'Stereo', 7, 'Design', 33, 4, 57, '2022-11-12', '2022-11-28', '2022-11-27', true, 8, 'Aenean lectus. Pellentesque eget nunc. Donec quis orci eget orci vehicula condimentum.

Curabitur in libero ut massa volutpat convallis. Morbi odio odio, elementum eu, interdum eu, tincidunt in, leo. Maecenas pulvinar lobortis est.');
insert into TASK (name, proj_title, client_ID, type, member_ID, lead_ID, task_number, date_assigned, date_due, date_finished, completion_status, hours, description) values ('Innovative local monitoring', 'Stereo', 7, 'Design', 4, 4, 58, '2022-10-5', '2022-10-15', null, false, null, 'Praesent blandit. Nam nulla. Integer pede justo, lacinia eget, tincidunt eget, tempus vel, pede.

Morbi porttitor lorem id ligula. Suspendisse ornare consequat lectus. In est risus, auctor sed, tristique in, tempus sit amet, sem.');
insert into TASK (name, proj_title, client_ID, type, member_ID, lead_ID, task_number, date_assigned, date_due, date_finished, completion_status, hours, description) values ('Intuitive web-enabled capability', 'Stereo', 7, 'Design', 20, 4, 59, '2022-9-24', '2022-10-6', null, false, null, 'In hac habitasse platea dictumst. Morbi vestibulum, velit id pretium iaculis, diam erat fermentum justo, nec condimentum neque sapien placerat ante. Nulla justo.');
insert into TASK (name, proj_title, client_ID, type, member_ID, lead_ID, task_number, date_assigned, date_due, date_finished, completion_status, hours, description) values ('User-friendly coherent internet solution', 'Stereo', 7, 'Backend', 27, 4, 60, '2022-10-4', '2022-10-21', null, false, null, 'Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id, turpis. Integer aliquet, massa id lobortis convallis, tortor risus dapibus augue, vel accumsan tellus nisi eu orci. Mauris lacinia sapien quis libero.');
insert into TASK (name, proj_title, client_ID, type, member_ID, lead_ID, task_number, date_assigned, date_due, date_finished, completion_status, hours, description) values ('Reactive system-worthy array', 'Stereo', 7, 'Design', 1, 4, 61, '2022-11-24', '2022-11-29', '2022-11-25', true, 6, 'Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id, turpis. Integer aliquet, massa id lobortis convallis, tortor risus dapibus augue, vel accumsan tellus nisi eu orci. Mauris lacinia sapien quis libero.

Nullam sit amet turpis elementum ligula vehicula consequat. Morbi a ipsum. Integer a nibh.');
insert into TASK (name, proj_title, client_ID, type, member_ID, lead_ID, task_number, date_assigned, date_due, date_finished, completion_status, hours, description) values ('Total real-time projection', 'Stereo', 7, 'Design', 7, 4, 62, '2022-10-19', '2022-11-28', '2022-11-12', true, 8, 'Duis aliquam convallis nunc. Proin at turpis a pede posuere nonummy. Integer non velit.

Donec diam neque, vestibulum eget, vulputate ut, ultrices vel, augue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec pharetra, magna vestibulum aliquet ultrices, erat tortor sollicitudin mi, sit amet lobortis sapien sapien non mi. Integer ac neque.');
insert into TASK (name, proj_title, client_ID, type, member_ID, lead_ID, task_number, date_assigned, date_due, date_finished, completion_status, hours, description) values ('Re-engineered value-added complexity', 'Stereo', 7, 'Design', 10, 4, 63, '2022-10-3', '2022-11-4', '2022-10-23', true, 6, 'Phasellus sit amet erat. Nulla tempus. Vivamus in felis eu sapien cursus vestibulum.

Proin eu mi. Nulla ac enim. In tempor, turpis nec euismod scelerisque, quam turpis adipiscing lorem, vitae mattis nibh ligula nec sem.');
insert into TASK (name, proj_title, client_ID, type, member_ID, lead_ID, task_number, date_assigned, date_due, date_finished, completion_status, hours, description) values ('Profound discrete task-force', 'Stereo', 7, 'Design', null, 4, 64, null, null, null, false, null, 'Donec diam neque, vestibulum eget, vulputate ut, ultrices vel, augue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec pharetra, magna vestibulum aliquet ultrices, erat tortor sollicitudin mi, sit amet lobortis sapien sapien non mi. Integer ac neque.

Duis bibendum. Morbi non quam nec dui luctus rutrum. Nulla tellus.');
insert into TASK (name, proj_title, client_ID, type, member_ID, lead_ID, task_number, date_assigned, date_due, date_finished, completion_status, hours, description) values ('User-friendly non-volatile paradigm', 'Stereo', 7, 'Design', 32, 4, 65, '2022-10-30', '2022-11-11', '2022-11-10', true, 9, 'Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.

Etiam vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida sem.');
insert into TASK (name, proj_title, client_ID, type, member_ID, lead_ID, task_number, date_assigned, date_due, date_finished, completion_status, hours, description) values ('Pre-emptive directional local area network', 'Stereo', 7, 'Design', null, 4, 66, null, null, null, false, null, 'Nulla ut erat id mauris vulputate elementum. Nullam varius. Nulla facilisi.');
...
Suspendisse potenti. In eleifend quam a odio. In hac habitasse platea dictumst.');
insert into TASK (name, proj_title, client_ID, type, member_ID, lead_ID, task_number, date_assigned, date_due, date_finished, completion_status, hours, description) values ('Enhanced leading edge info-mediaries', 'Stereo', 3, 'Design', 12, 4, 68, '2022-11-3', '2022-11-7', '2022-11-7', true, 3, 'Phasellus in felis. Donec semper sapien a libero. Nam dui.');
